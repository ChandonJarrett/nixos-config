...
set -gx BASE16_BACKGROUND "@base00@"
set -gx BASE16_FOREGROUND "@base05@"
set -gx BASE16_CURSOR "@base07@"
...
if type -q fzf
  ...
  set -gx FZF_DEFAULT_OPTS "
    ...
    --pointer='\uF114'
    --marker='\uF5CF'
    --color=bg:@base00@,fg:@base05@
    --color=bg+:@base01@,fg+:@base07@
    --color=hl:@base0D@,hl+:@base0E@
    --color=prompt:@base0A@,pointer:@base0C@,marker:@base0B@
  "
end
...
function lf --wraps="@lf@"
  set -l dir (@lf@ -print-last-dir $argv)
